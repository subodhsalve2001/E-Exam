...
const questions = [
    {
        ...
        option: ["state management tool", "deployment library", "data storing tool", "NON"],
        answer: "state management tool"
    },
    {
        id: "w2",
...
export default function Test() {
    ...
    const [selectedQuetion, setselectedQuetion] = useState({ ...questions[0] })
    ...
    const handleNext = () => {
        setQIndex(pre => pre < questions.length - 1 ? pre + 1 : pre)
    }
    const handleBack = () => {
    ...
    const handleProgress = () => {
        setpercentage((qIndex + 1) / questions.length * 100)
        if (percentage < 35) {
            setbg("bg-danger")
        }
    ...
    useEffect(() => {
        setselectedQuetion({ ...questions[qIndex] })
        handleProgress()
    }, [qIndex, percentage])
        ...
        <div className="container-fluid">
            ...
            <div className="row">
                <div className="col-sm-8 col-md-6 offset-md-3 offset-sm-2">
                    {
                        show && <div class="alert alert-success text-info alert-dismissible fade show" role="alert">
                            <h1><strong>Result!</strong></h1>
                            <h4><strong>Total Questions =</strong>  {questions.length}</h4>
                    ...
                    <div className="card bg-transparent">
                        ...
                        <div className="card-footer d-flex justify-content-between">
                            ...
                            {
                                !(questions.length - 1 === qIndex) && <button
                                    onClick={handleNext}
                                    className='btn btn-sm'>
                                    Next
                                </button>
                    ...
                    <button
                        ...
                        className='btn btn-outlined-primary submit-btn w-100 mt-3'>Submit Answer
                    </button>
                </div>
            </div>
        </div >
